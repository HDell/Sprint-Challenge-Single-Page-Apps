...
> Answer: With client side routing, a web-page is loaded at the beginning of the session and switching to different URLs does not initiate more network calls.
...
- [ ]  Use a styling or component library for part of or all of your application. (Pick at least 1 of: [s](https://react-bootstrap.github.iostyled-components or Reactstrap).
